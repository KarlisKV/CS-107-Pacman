...
public enum SuperPacmanSound {
    ...
    RETREATING(new SoundAcoustics(ResourcePath.getSounds("superpacman/retreating"), 1.f, false, false, true, false)),
    SIREN(new SoundAcoustics(ResourcePath.getSounds("superpacman/siren_1"), 1.f, false, false, true, false)),
    POWER_PELLET(
            new SoundAcoustics(ResourcePath.getSounds("superpacman/power_pellet"), 1.f, false, false, true, false)),
    PACMAN_DEATH(new SoundAcoustics(ResourcePath.getSounds("superpacman/death_1"), 1.f, false, false, false, false)),
