...
public class Inky extends Ghost {
    ...
    protected DiscreteCoordinates getTargetWhileFrightened() {
        return getRandomValidElement(
                    getCellsFromRange(new DiscreteCoordinates(24, 24), MAX_DISTANCE_WHEN_SCARED, false));
    }
    ...
    protected DiscreteCoordinates getTargetDefault() {
        return getRandomValidElement(
                    getCellsFromRange(new DiscreteCoordinates(24, 24), MAX_DISTANCE_WHEN_NOT_SCARED, false));
    }
